...
the hypothesis could have failed. Therefore, as a supplement to a larger
project (see preregistration Gorman et al.~(2024)), we conducted a
qualitative content analysis, using NVivo (version 14), of hypothesis
...
Meehl (\citeproc{ref-meehl_appraising_1990}{1990, p. 110}) and figure
5.3 of Lakens (\citeproc{ref-lakens_improving_2022}{2022, pp.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figures/figure_1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Figures/dv_wordcloud.png}}
