...
\section{The Claims we make}\label{the-claims-we-make}
...
eﬀorts, and because knowing the truth matters.}''. We therefore must
...
(\textless\textgreater). The analysis code related to this study is
publicly available on GitHub (\textless\textgreater).
